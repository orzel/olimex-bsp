...
#include "bsp/olimex_esp32_p4_pc.h"
...
static const char *TAG = "ESP32-P4-PC";
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    const esp_lcd_dpi_panel_config_t *dpi = vendor_config.mipi_config.dpi_config;
    ESP_LOGI(TAG, "DPI: pclk=%.3f h=%u v=%u", (double)dpi->dpi_clock_freq_mhz, (unsigned)dpi->video_timing.h_size, (unsigned)dpi->video_timing.v_size);
